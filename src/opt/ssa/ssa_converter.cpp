...
SSAConverter::PerRegister *SSAConverter::GetPerRegister(IRegister *reg) {
...
void SSAConverter::PropagatePHIforBB(SSAConverter::PerRegister *pr,
				     BB *bb) {
  vector<BB *> frontier;
...
void SSAConverter::PrependState(BB *bb) {
