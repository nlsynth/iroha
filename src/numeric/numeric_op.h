...
class Op {
 public:
  ...
  static void MakeConst(uint64_t value, const NumericWidth &w, NumericValue *v);
  ...
  static void CalcBinOp(enum BinOp op, const NumericValue &x,
                        const NumericValue &y, const NumericWidth &w,
                        NumericValue *res);
